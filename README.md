...
- 岗位汇总：2027 届相关记录 2380 条（2026-08-08 最新导出），可按公司/岗位搜索，按行业、批次筛选，支持分页加载；
  每条包含批次、行业、地点、开始/截止时间、投递链接、公告链接、是否笔试。
- 内推码：297 条企业内推码，可按公司搜索。

总览页会额外合并朱迪表中「人力资源 / HR / 游戏运营 / 游戏发行 / 游戏营销 / 游戏策划 /
游戏市场 / 游戏生态 / 游戏用户 / 游戏社区 / 游戏内容 / 游戏商业化」相关的非实习岗位公司
（目前约 27 家），合计约 72 家；排序规则为已投递优先、有面经次之。
...
- 「面经库」：73 条来自《面经分享.pdf》的企业面经（美团/米哈游/叠纸/网易游戏/B站/唯品会等，
  展开即可阅读内容）+ 12 条真实链接（内推/日程/资讯），按公司挂在对应公司的详情页里，
  也可在面经库页按平台和类型筛选。
- 「通用问题」：70 道来自《校招面试通用常见问题及参考答案.pdf》的题目，含考查意图、
  回答思路与参考答案，点击可展开。
